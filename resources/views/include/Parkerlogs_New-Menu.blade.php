  ...
  <ul>
    <li class="nav-item" >
      <a class="nav-link active" href="/home">
        ...
        <span style="color: rgba(94,114,228,255); font-size: 16px"><b> Dashboard </b></span>
      </a>
    </li>
{{--    <li class="nav-item">--}}
      ...
      <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
             aria-expanded="false">
              ...
              <span style="color: rgba(94,114,228,255); background-color: grey; font-size: 16px">User List</span>
          </a>
          <div class="dropdown-menu">
              ...
              <a href="/user" class="nav-link">
                  <i class="ni ni-single-02 text-yellow"></i>
                  <span style="color: rgba(94,114,228,255); font-size: 16px"><b>All User</b></span>
              </a>
          </div>
      </li>
      @endrole
       <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
             aria-expanded="false">
              ...
              <span style="color: rgba(94,114,228,255); font-size: 16px"><b> Report</b></span>
          </a>
          <div class="dropdown-menu">
              <a href="#" class="nav-link">
                  <i class="ni ni-single-02 text-yellow"></i>
                  <span style="color: rgba(94,114,228,255); font-size: 16px"><b>Monthly Report</b></span>
              </a>
              <a href="#" class="nav-link">
                  <i class="ni ni-single-02 text-yellow"></i>
                  <span style="color: rgba(94,114,228,255); font-size: 16px"><b> Report</b></span>
  ...
  <ul class="navbar-nav mb-md-3">
    ...
    <li class="nav-item">
      <a class="nav-link" href="/scanner-test"
        ...
        <span style="color: rgba(94,114,228,255); font-size: 16px"><b> Scanner Form </b></span>
      </a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="/RegisteredVehicle"
        >
        <i class="ni ni-palette"></i>
        <span style="color: rgba(94,114,228,255); font-size: 16px"><b> Registered Vehicle </b></span>
      </a>
    </li>
<div >
    <hr class="my-3" style="background-color: grey;" >
    <h6 class="navbar-heading p-0 text-muted">
      <span style="color: rgba(94,114,228,255); font-size: 16px"><b> about </b></span>
    </h6>
    <li class="nav-item">
      <a class="nav-link" href="/Rules"
        >
        <i class="ni ni-palette"></i>
        <span style="color: rgba(94,114,228,255); font-size: 16px"><b> parking Rules</b></span>
    ...
    <li class="nav-item">
      <a class="nav-link" href="mission"
        >
        <i class="ni ni-palette"></i>
        <span style="color: rgba(94,114,228,255); font-size: 16px"><b> Mission/Vission </b></span>
      </a>
    </li>
